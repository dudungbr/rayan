 ...
 * $Date: 2010-09-23 10:54:04 -0300 (qui, 23 set 2010) $
 * @author Rayan
 */
...
public class LogonUsuario extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        rotuloUsuario.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        rotuloUsuario.setText("Usuário");
        jPanel1.add(rotuloUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, -1, 10));

        rotuloSenha.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)
        );

        getRootPane().setDefaultButton(botaoLogin);

        setSize(new java.awt.Dimension(236, 184));
    ...
    private void botaoLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoLoginActionPerformed
         ...
         * else
         * {
         * Util.showErrorMsg(Auth.LAST_USER + ", voce nao tem privilegios para
         * esta operação.");
         * }
         */
